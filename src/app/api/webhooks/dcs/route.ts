...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  //    DB writes). Push those to a background queue so walleyeone doesn't
  ...
  switch (event.type) {
    ...
    default: {
      // Unknown event type — log and ignore. walleyeone may add event types
  ...
  //    walleyeone retries on non-2xx. Return 200 quickly; do real work async.
